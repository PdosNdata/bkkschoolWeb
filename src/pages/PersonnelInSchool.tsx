...
import { ArrowLeft, Users, FileText, UserCheck, Mail, Phone, Building, Grid3X3, List } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-6 mb-8 text-white">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold mb-2">บุคลากรในโรงเรียน</h1>
            ...
            <Card className="text-center py-16">
              <CardContent>
                ...
                <p className="text-gray-500 mb-6">
                  ขออภัย ยังไม่มีข้อมูลบุคลากรให้แสดง
                </p>
              </CardContent>
            </Card>
          ) : (
...
export default PersonnelInSchool;